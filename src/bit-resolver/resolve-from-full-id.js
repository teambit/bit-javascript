...
const parseBitFullId = require('bit-scope-client/dist/bit-id/parse-bit-full-id');
const resolveBit = require('./bit-resolver');
const { LATEST_VERSION } = require('../constants');
const findLatestVersion = require('bit-scope-client/dist/bit-id/find-latest-version');
